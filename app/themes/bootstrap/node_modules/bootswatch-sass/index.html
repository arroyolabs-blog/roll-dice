...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <h1>Free themes for Bootstrap - SASS version</h1>
            <div id="social">
              <span>
                <iframe id="gh-fork" src="http://ghbtns.com/github-btn.html?user=guru-digital&repo=bootswatch-sass&type=fork" allowtransparency="true" frameborder="0" scrolling="0" width="53" height="20"></iframe>
                <iframe id="gh-star" src="http://ghbtns.com/github-btn.html?user=guru-digital&repo=bootswatch-sass&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
              </span>
              <span>
    ...
    <div class="section-tout" style="padding-top: 1em;">
      <div class="container">
        <div class="row">
          <div class="col-sm-12" style="text-align: center">
            <h1 style="margin-top: ">This is a port of the original <a href="http://bootswatch.com">Bootswatch</a> converted to SASS.</h1>
            <h2><a href="http://bootswatch.com">Checkout the offical LESS version of Bootswatch</a></h2>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <p>Bootstrap themes are released under the MIT License and maintained by the community on <a target="_blank" href="https://github.com/guru-digital/bootswatch-sass">GitHub</a>.</p>
          </div>
          <div class="col-lg-4 col-sm-6">
            <h3><i class="fa fa-wrench"></i> Tuned for 3.2.0</h3>
            <p>Themes are built for the latest version of Bootstrap. <a href="2/">Version 2.3.2</a> and <a target="_blank" href="https://github.com/guru-digital/bootswatch-sass/tags">others</a> are also available to download.</p>
          </div>
          <div class="col-lg-4 col-sm-6">
            <h3><i class="fa fa-cogs"></i> Modular</h3>
             <p>Changes are contained in just two SCSS files, enabling modification and ensuring forward compatibility.</p>
          </div>
          <div class="col-lg-4 col-sm-6">
              ...
              <div class="options">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a target="_blank" href="sandstone/_variables.scss"
                      onClick="_gaq.push(['_trackEvent', 'bootswatch', 'sandstone', '_variables.scss']);">_variables.scss</a></li>
                    <li><a target="_blank" href="sandstone/_bootswatch.scss"
                      onClick="_gaq.push(['_trackEvent', 'bootswatch', 'sandstone', '_bootswatch.scss']);">_bootswatch.scss</a></li>
                  </ul>
                </div>
              </div>
            </div>
