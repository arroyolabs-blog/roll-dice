      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-lg-9">
            ...
            <ol>
              <li><p>Download the repository: <code>git clone https://github.com/guru-digital/bootswatch-sass.git</code></p></li>
              ...
              <li><p>Modify <code>_variables.scss</code> and <code>_bootswatch.scss</code> in one of the theme directories, or create your own in <code>/custom</code>.</p></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>Here's a demo of the API in action.</p>
            <a class="jsbin-embed" href="http://jsbin.com/rabij/1/embed?html,js,output&height=500px">Bootswatch API Demo</a><script src="http://static.jsbin.com/js/embed.js"></script>
          </div>
        </div>
