    ...
    <div class="span5 offset1">
      <div class="well">
        <div class="pull-left" style="padding-right: 1em;">
          <a href="http://sharktankshopper.com" target="_blank"><img src="../img/sharktankshopper.png" style="width: 120px;"></a>
        </div>
        <div class="clearfix">
          <h3><a href="http://sharktankshopper.com" target="_blank">Shark Tank Shopper</a></h3>
          <p><a href="http://sharktankshopper.com" target="_blank">Find products as seen on ABC's television show Shark Tank</a></p>
        </div>
      </div>
    </div>
  </div>
