              ...
              <div class="options">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a target="_blank" href="sandstone/variables.less"
                      onClick="_gaq.push(['_trackEvent', 'bootswatch', 'sandstone', 'variables.less']);">variables.less</a></li>
                    <li><a target="_blank" href="sandstone/bootswatch.less"
                      onClick="_gaq.push(['_trackEvent', 'bootswatch', 'sandstone', 'bootswatch.less']);">bootswatch.less</a></li>
                  </ul>
                </div>
              </div>
            </div>
