...
class Example extends \erdiko\core\Controller
{
    ...
    public function getIndex()
    {
        ...
        $this->addView('examples/dice');
        $this->addMeta("description", "Roll the dice blog app");
        $this->addJs('dice','/themes/bootstrap/scripts/dice/dice.js');
    }
    ...
    public function getDiceRequest(){
        $diceModel = new \app\models\Dice;
        $diceResult = $diceModel->roll_dice(1,6,false);
        $data = $diceResult;
        // Add page data
        $this->setTitle('Dice Result');
        $this->addView('examples/dice_result', $data);
        $this->addMeta("description", "Dice result view.");
    }
